...
$(".header .logo").on("click", function () {
    window.open("https://www.joinhgs.com/ca/career-playbook", "_blank");
});
...
function screen10() {
    ...
    let teamLeadEndText = bodymovin.loadAnimation({
        ...
        loop: false,
        autoplay: false,
        path: "json/team-lead-endtext/us-ca/data.json",
    });
        ...
        gsap.to(" #team-lead-endtext", 0.5, {
            ...
            onComplete: function () {
                ...
                airportBackgroundAnimation = bodymovin.loadAnimation({
                    ...
                    loop: true,
                    autoplay: false,
                    path: "json/airport-background/us-ca/data.json",
                });
            },
        });
    });
...
$("#apply-share-button .apply-btn").on("click", function () {
    next.play();
    window.open("https://www.joinhgs.com/ca/current-openings", "_blank");
});
